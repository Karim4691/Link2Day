...
export default function EventCard({ event }) {
  ...
  return (
    <Link to={`/events/${event._id}`}>
      <div className="text-left flex flex-row items-start cursor-pointer max-h-48 pr-2 mb-6 w-fit">
        <img src={event.photoUrl} alt="Event" className='h-44 mr-2 p-2 rounded-xl w-32 md:w-64' />
